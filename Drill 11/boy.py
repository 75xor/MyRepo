...
class DashState:
    ...
    def do(boy):
        ...
        boy.x += boy.velocity * boy.acceleration
        boy.x = clamp(25, boy.x, 800 - 25)
    def draw(boy):
        if boy.velocity == 1:
            boy.image.clip_draw(boy.frame * 100, 100, 100, 100, boy.x, boy.y)
...
SLEEP_TIMER: SleepState,SHIFT_UP:IdleState, SHIFT_DOWN: IdleState},
...
LEFT_UP: RunState, RIGHT_UP: RunState,SHIFT_UP:SleepState, SHIFT_DOWN: SleepState},
